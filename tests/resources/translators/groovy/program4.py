...
cls_a_str = cls_a.get_type().new([gt.String])
cls_a_any = cls_a.get_type().new([gt.Object])
...
cls_b_double_integer = cls_b.get_type().new([gt.Double, gt.Integer])
cls_b_any_integer = cls_b.get_type().new([gt.Object, gt.Integer])
